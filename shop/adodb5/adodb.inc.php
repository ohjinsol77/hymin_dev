...
*/
	...
	var $database = 'study';			/// Name of database to be used.
	var $host = 'localhost';				/// The hostname of the database server
	var $port = '22';				/// The port of the database server
	var $user = 'root';				/// The username which is used to connect to the database server.
	var $password = 'Kdkdldpadkdl123$%^';			/// Password for the username. For security, we no longer store it.
