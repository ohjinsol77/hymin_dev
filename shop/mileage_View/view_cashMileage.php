...
try{
        ...
        $rs = $db->Execute("select cash_regdate, cash_type, cash_price, cash_amount from cash_mileage where member_num=$member_Num order by cash_regdate desc limit 10 for update");
        if (!$rs) {
